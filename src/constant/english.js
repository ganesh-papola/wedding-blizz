export default {
    ...
    'tnc':{
        ...
        'RulesConductForPostingTerms' : 'See the Agreement for a list of the rules you agree to abide by when you use WeddingBlizz, such as not soliciting money from other users, harassing other users or using the Service for any illegal purposes.  You shall not post any content that (a) is libelous, defamatory, obscene, pornographic, abusive, harassing or threatening; (b) contains viruses or other contaminating or destructive features; (c) violates the rights of others, such as content that infringes any copyright, trademark, patent, trade secret or violates any right of privacy or publicity; or (d) otherwise violates any applicable law. You may not post any links to any external Internet sites that are obscene or pornographic.',
